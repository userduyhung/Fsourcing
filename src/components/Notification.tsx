...
const Notification: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 w-full max-w-xs font-sans">
      <div className="flex items-center mb-3">
        <Bell className="w-5 h-5 text-blue-600 mr-2" />
        <span className="font-semibold text-gray-900 font-sans">Thông báo</span>
      </div>
      <div className="space-y-3">
        {notifications.map(n => (
          <div key={n.id} className="flex items-center text-sm text-gray-700 font-sans">
